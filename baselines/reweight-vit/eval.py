...
overall_prec3 = validate(args, val_loader, model, criterion, False)
...
plt.plot(k * np.arange(len(accs_avg_prec3_acc)), gaussian_filter1d(accs_avg_prec3_acc, 300), 'g',
         label='reweight-ViT-deferred')
...
latex_str = ''.join(['reweight-ViT-deferred'] + [' & ' + str(e) + r'\%' for e in decile_accs_prec3])
